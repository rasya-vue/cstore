...
int main(void) {
    // inisialisasi barang
    Barang barang[] = {
        {"Xiaomi Redmi Note 10S", 10, 2499000},
        {"Screen Protector Xiaomi Redmi Note 10S", 20, 25000},
        {"Soft Case Xiaomi Redmi Note 10S", 15, 75000},
        {"iPhone 12 Pro", 12, 12000000}
    ...
    while (1) {
        ...
        else if (strcmp(pilihan, "Hapus") == 0) {
